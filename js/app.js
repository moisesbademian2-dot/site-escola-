...
const MENUS = {
  diretor: [
    ...
    { group: 'Acompanhamento', items: [ { id: 'diario', icon: 'book', label: 'Diário de Classe' }, { id: 'frequencia', icon: 'checkCircle', label: 'Frequência' }, { id: 'notas', icon: 'edit', label: 'Notas' }, { id: 'fechamento', icon: 'lock', label: 'Fechamento' }, { id: 'ocorrencias', icon: 'alert', label: 'Ocorrências' }, { id: 'justificativas', icon: 'clipboard', label: 'Justificativas' }, { id: 'comunicados', icon: 'megaphone', label: 'Comunicados' } ]}
  ],
  coordenador: [
    ...
    { group: 'Acompanhamento', items: [ { id: 'diario', icon: 'book', label: 'Diário de Classe' }, { id: 'notas', icon: 'edit', label: 'Notas' }, { id: 'fechamento', icon: 'lock', label: 'Fechamento' }, { id: 'frequencia', icon: 'checkCircle', label: 'Frequência' }, { id: 'ocorrencias', icon: 'alert', label: 'Ocorrências' }, { id: 'justificativas', icon: 'clipboard', label: 'Justificativas' }, { id: 'comunicados', icon: 'megaphone', label: 'Comunicados' }, { id: 'relatorios', icon: 'chart', label: 'Relatórios' } ]}
  ],
  professor: [
    ...
    { group: 'Extras', items: [ { id: 'atividades', icon: 'clipboard', label: 'Atividades' }, { id: 'ocorrencias', icon: 'alert', label: 'Ocorrências' }, { id: 'justificativas', icon: 'clipboard', label: 'Justificativas' }, { id: 'comunicados', icon: 'megaphone', label: 'Comunicados' } ]}
  ],
  aluno: [
    ...
    { group: 'Escola', items: [ { id: 'historico', icon: 'clipboard', label: 'Histórico' }, { id: 'atividades', icon: 'clipboard', label: 'Atividades' }, { id: 'comunicados', icon: 'megaphone', label: 'Comunicados' }, { id: 'ocorrencias', icon: 'alert', label: 'Ocorrências' }, { id: 'justificativas', icon: 'clipboard', label: 'Justificativas' }, { id: 'perfil', icon: 'user', label: 'Meu Perfil' } ]}
  ],
  responsavel: [
    ...
    { group: 'Escola', items: [ { id: 'historico', icon: 'clipboard', label: 'Histórico' }, { id: 'atividades', icon: 'clipboard', label: 'Atividades' }, { id: 'comunicados', icon: 'megaphone', label: 'Comunicados' }, { id: 'ocorrencias', icon: 'alert', label: 'Ocorrências' }, { id: 'justificativas', icon: 'clipboard', label: 'Justificativas' }, { id: 'perfil', icon: 'user', label: 'Perfil do Aluno' } ]}
  ]
};
